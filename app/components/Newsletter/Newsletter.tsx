            ...
            <div className="mx-auto max-w-2xl bg-pink br-50 md:max-w-7xl mt-48 rounded-lg">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className="col-span-7">
                        <div className="m-10 lg:ml-32 lg:mt-20 lg:mb-20">
                            <Fade direction={'up'} delay={400} cascade damping={1e-1} triggerOnce={true}>
                                <div className="flex">
                                <AiOutlineShoppingCart className="text-white mr-3 text-2xl"></AiOutlineShoppingCart>
                                <h3 className="text-lg font-normal text-white mb-3 ls-51"> Tienda Online </h3>
                                </div>
                    ...
                    <div className="col-span-5 relative hidden md:block">
                        <div>
                            <Image src={'/images/Newsletter/work.png'} alt="soup-image" width={626} height={550} className='-mt-24' />
                        </div>
